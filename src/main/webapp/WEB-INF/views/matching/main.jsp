...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/matchingMain.css">
...
<c:if test="${user.auth==2}">
	<button id="my_emp_register" class="register" onclick="my_emp_register(${user.mem_num})">
					...
					<a href="#" data-id="${member.mem_num}">
					 ...
					 <div class="profile-dropdown">
					    ...
					    <div class="profile-dropdown-content">
					        ...
					        <a class="detail" href="#" onclick="make_chat('${member.mem_num}')" data-id="${member.mem_num}">채팅하기</a>
...
<script> var empListJson = '${empListJson}';</script>
...
<script>
	...
	var content =' <img src="${pageContext.request.contextPath}/matching/viewProfile?userNum='+userNum+'" width="40" height="40" class="my-photo">'
...
<script>
	    ...
	    console.log("empList의 정보:", empList);
