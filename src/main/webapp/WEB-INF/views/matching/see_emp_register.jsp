...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/emp_register.css">
<script>
	function closePopup(){
		window.close();
	}
...
<h2>${empVO.name}님의 취업정보</h2>
	<table>
	<tr>
		<td style="width:200px">이름</td>
		<td colspan="7">${empVO.name}</td>
	</tr>
	<tr>
		<td>이메일</td>
		<td colspan="5">${empVO.email}</td>
	</tr>
	<tr>
		<td>회사규모</td>
	...
	<c:if test="${empVO.salary_status}==공개">
	<tr>
